 ...
 * @author    Cora Wong <email@example.com>
 * @license   GPL-2.0+
 ...
 * Plugin URI:        https://github.com/corawym
 * Description:       @TODO
 * Version:           1.0.0
 * Author:            Cora Wong
 * Author URI:        https://github.com/corawym
 * License:           GPL-2.0+
...
class Inhabitent_Business_Hours extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'inhabitent_business_hours';
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['sunday'] = strip_tags( $new_instance['sunday'] );// TODO: Here is where you update the rest of your widget's old values with the new, incoming values
